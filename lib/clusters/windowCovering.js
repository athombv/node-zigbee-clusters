...
const ATTRIBUTES = {
  ...
  installedOpenLimitLift: { id: 0x0010, type: ZCLDataTypes.uint16 }, // 16, Mandatory
  installedClosedLimitLift: { id: 0x0011, type: ZCLDataTypes.uint16 }, // 17, Mandatory
  installedOpenLimitTilt: { id: 0x0012, type: ZCLDataTypes.uint16 }, // 18, Mandatory
  installedClosedLimitTilt: { id: 0x0013, type: ZCLDataTypes.uint16 }, // 19, Mandatory
