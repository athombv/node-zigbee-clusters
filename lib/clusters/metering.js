...
const ATTRIBUTES = {
  ...
  energyCarrierUnitOfMeasure: { id: 0x0309, type: ZCLDataTypes.enum8({/* TODO fix */}) }, // 777, Optional
  // TODO: map8 packed fields — bits 0-2: right digits, 3-6: left digits, 7: suppress zeros
  ...
  temperatureUnitOfMeasure: { id: 0x030C, type: ZCLDataTypes.enum8({/* TODO fix */}) }, // 780, Optional
  // TODO: map8 packed fields — bits 0-2: right digits, 3-6: left digits, 7: suppress zeros
  ...
  alternativeUnitOfMeasure: { id: 0x0312, type: ZCLDataTypes.enum8({/* TODO fix */}) }, // 786, Optional
  // TODO: map8 packed fields — bits 0-2: right digits, 3-6: left digits, 7: suppress zeros
  ...
  proposedChangeSupplyStatus: { id: 0x0B01, type: ZCLDataTypes.enum8({/* TODO fix */}) }, // 2817, Optional
