...
const ATTRIBUTES = {
   ...
   * Description:   Length of time, in tenths of a second, that the ballast takes to move to the light level specified in PowerOnLevel when power is applied.
   * Default:       0x0000
   * Values:        0x0000 – 0xfffe
   */
  PowerOnFadeTime: {
    id: 19,
   ...
   * Description:   Percentage the ballast factor of the ballast/lamp combination (see also 5.3), prior to any adjustment.
   * Default:       -
   * Values:        0x00 – 0xfe
   */
   ...
   * Description:   Multiplication factor, as a percentage, to be applied to the configured light output of the lamps
   * Default:       0xff
   * Values:        0x64 – Manufacturer Specific
   */
   ...
   * Description:   Number of hours of use the lamps are rated for by the manufacturer. A value of 0xffffff indicates an invalid or unknown time.
   * Default:       0xffffff
   ...
   * Description:   Length of time, in hours, the currently connected lamps have been operated, cumulative since the last re-lamping.
   * Default:       0x000000
   * Values:        0x000000 – 0xfffffe
   */
  LampBurnHours: {
   ...
   * Description:   Which attributes MAY cause an alarm notification to be generated. A '‘1’ in each bit position causes its associated attribute to be able to generate an alarm
   * Default:       0b0000 0000
   * Values:        
   * Bit  | Attribute
   * 0    | LampBurnHours
   ...
   * Description:   Number of hours the LampBurnHours attribute MAY reach before an alarm is generated.
   * Default:       0xffffff
   * Values:        0x000000 – 0xfffffe
   */
