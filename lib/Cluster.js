...
class Cluster extends EventEmitter {
    ...
    async handleFrame(frame, meta, rawFrame) {
        ...
        // console.log('handleFrame', frame, commands, this);
        ...
        // console.log('found command', command, frame.cmdId, this.constructor.commandsById)
        if(command) {
            ...
            console.log('found handler', handler, 'frame trx', frame.trxSequenceNumber, 'trxHandlers', Object.keys(this._trxHandlers), handlerName);
            if(handler) {
              console.log("call handler", args, meta, frame)
        ...
        for(const cmdName in commands) {
            Object.defineProperty(proto, cmdName, {
                value: {[cmdName]: async function(args) {
                    ...
                    console.log('command', cmdName, 'trxSeqNr', payload.trxSequenceNumber, this);
