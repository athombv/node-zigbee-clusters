...
class Node extends EventEmitter {
    ...
    async handleFrame(endpointId, clusterId, frame, meta) {
        ...
        let response = (frame.frameControl.disableDefaultResponse || (meta && meta.groupId)) ? null : this._makeErrorResponse(endpointId, clusterId, frame);
        ...
        try {
            ...
            console.log('error while handling frame', e.message, {endpointId, clusterId, meta, frame});
        }
        if(response) {
